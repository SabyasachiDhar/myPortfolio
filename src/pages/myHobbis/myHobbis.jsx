...
const MyHobbies = () => {
  return (
    <section className="my-4">
      <h2>My Hobbies</h2>
      <p>
        When I'm not coding, I love spending my time on various activities that help me relax and recharge. Here are some of my favorite hobbies:
      </p>
      <ul>
        <li><strong>Reading:</strong> I enjoy reading a variety of genres, including science fiction, mystery, and tech blogs.</li>
